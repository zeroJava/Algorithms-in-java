...
public class LinkeddListtt {
	
	private Nodee head;
	
	public LinkeddListtt()
	{
		head = null;
	}
	
	public void addToStart(int count, String item)
	{
	...
	{
		LinkeddListtt linkeddListtt = new LinkeddListtt();
		System.out.println(linkeddListtt.isListEmpty());
		linkeddListtt.addToStart(45, "Apples");
		linkeddListtt.addToStart(75, "Tree");
		linkeddListtt.addToStart(25, "Cat");
